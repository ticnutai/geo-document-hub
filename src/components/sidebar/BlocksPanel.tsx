...
import { Loader2, ChevronDown, ChevronLeft, Landmark } from "lucide-react";
...
export default function BlocksPanel() {
  ...
  const filteredBlocks = blocks.filter((b) => !search || b.includes(search));

  // Also get blocks from plansByBlock
